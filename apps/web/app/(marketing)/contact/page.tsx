  ...
  return (
    <>
      <PageHero
        eyebrow="Contact"
        title="Get in touch"
        description="Send your turnover details and we will follow up with next steps and availability."
      />
      ...
      <section className="mx-auto grid max-w-6xl gap-6 px-4 py-12 sm:px-6 md:grid-cols-[1fr_420px]">
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p>Service Area: Rental apartments and multifamily turnovers</p>
          </div>
        </div>
